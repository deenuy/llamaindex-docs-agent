...
<br>
<div align="center">
    <img src="assets/images/logo.png" alt="LlamaIndex Docs Agent Logo" width=200 height=200>
</div>
...
- Add the `openai_api_key` and the `tavily_api_key` variables in the [`.env.example`](archive/docker/.env.example) file and modify the name of the file to `.env`. Get these keys:
...
<div align='center'>
    <img src="assets/images/workflow.png" alt="LlamaIndex Docs Agent workflow">
</div>
